 ...
 *
 * Separate from [com.example.displayapp.data.bluetooth.BluetoothDataSource], which
 ...
 *  - One instance per process — wired through [com.example.displayapp.di.AppContainer].
 */
