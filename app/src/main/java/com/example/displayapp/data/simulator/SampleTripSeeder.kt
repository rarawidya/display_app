 ...
 * first time the user opens the app while [com.example.displayapp.di.AppContainer.useSimulator]
 * is on.
 *
 * The per-sample telemetry is generated with the **exact** waveforms that
 * [com.example.displayapp.data.simulator.ScenarioGenerator.cityCruise]
