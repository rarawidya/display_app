...
import com.innodrive.evdash.data.bluetooth.ble.BleConstants
 ...
 * `ScanCallback`).
 *
 * The sheet UI ([com.innodrive.evdash.presentation.ui.connection.BluetoothManagementSections])
 * and [com.innodrive.evdash.presentation.viewmodel.BluetoothViewModel] are unchanged
