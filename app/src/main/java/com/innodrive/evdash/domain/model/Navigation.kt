 ...
 * are mapped onto this fixed set by the [com.innodrive.evdash.domain.repository.NavigationProvider]
 ...
 * [com.innodrive.evdash.domain.repository.NavigationProvider] per GPS fix / SDK
