...
import com.innodrive.evdash.di.AppContainer
import com.innodrive.evdash.presentation.ui.maps.LocalMapProvider
import com.innodrive.evdash.domain.model.ConnectionState
import com.innodrive.evdash.presentation.ui.charts.ChartsScreen
import com.innodrive.evdash.presentation.ui.connection.BluetoothQuickSheet
import com.innodrive.evdash.presentation.ui.connection.BluetoothStatusPopover
import com.innodrive.evdash.presentation.ui.dashboard.DashboardScreen
import com.innodrive.evdash.presentation.ui.device.DeviceScanScreen
import com.innodrive.evdash.presentation.ui.home.HomeScreen
import com.innodrive.evdash.presentation.ui.home.LastRide
import com.innodrive.evdash.presentation.ui.logs.LogsScreen
import com.innodrive.evdash.presentation.ui.logs.TripDetailScreen
import com.innodrive.evdash.presentation.ui.maps.NavigationScreen
import com.innodrive.evdash.presentation.ui.settings.DeveloperScreen
import com.innodrive.evdash.presentation.ui.settings.SettingsScreen
import com.innodrive.evdash.presentation.viewmodel.BluetoothViewModel
import com.innodrive.evdash.presentation.viewmodel.BluetoothViewModelFactory
import com.innodrive.evdash.presentation.viewmodel.ChartsViewModel
import com.innodrive.evdash.presentation.viewmodel.ChartsViewModelFactory
import com.innodrive.evdash.presentation.viewmodel.DashboardViewModel
import com.innodrive.evdash.presentation.viewmodel.DashboardViewModelFactory
import com.innodrive.evdash.presentation.viewmodel.LogsViewModel
import com.innodrive.evdash.presentation.viewmodel.LogsViewModelFactory
import com.innodrive.evdash.presentation.viewmodel.MapsViewModel
import com.innodrive.evdash.presentation.viewmodel.MapsViewModelFactory
import com.innodrive.evdash.presentation.viewmodel.SettingsViewModel
import com.innodrive.evdash.presentation.viewmodel.SettingsViewModelFactory
import com.innodrive.evdash.presentation.viewmodel.ThemeViewModel
import com.innodrive.evdash.presentation.viewmodel.ThemeViewModelFactory
import kotlinx.coroutines.CoroutineScope
import kotlinx.coroutines.launch
import com.innodrive.evdash.presentation.viewmodel.TripDetailViewModel
import com.innodrive.evdash.presentation.viewmodel.TripDetailViewModelFactory
    ...
    NavHost(
        ...
        composable(Destination.Home.route) {
            ...
            LaunchedEffect(Unit) {
                ...
                val adapterOff = container.bluetoothController.adapterState.value ==
                    com.innodrive.evdash.data.bluetooth.controller.AdapterState.OFF
        ...
        composable(Destination.Drive.route) {
            ...
            val mapsVm: MapsViewModel = viewModel(
                factory = MapsViewModelFactory(container.locationRepository, container.navigationCoordinator, container.geocoder, container.vehicleRepository.vehicleData, container.efficiencyTracker.state)
            )
            val btVm: BluetoothViewModel = viewModel(
                factory = BluetoothViewModelFactory(
                    controller = container.bluetoothController,
