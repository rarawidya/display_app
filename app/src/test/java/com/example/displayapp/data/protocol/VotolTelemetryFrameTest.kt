...
class VotolTelemetryFrameTest {
    ...
    fun decoder_accepts_reference_frame_and_yields_expected_fields() {
        ...
        assertEquals(0, t.motorCurrentRaw)
    ...
    fun mapper_translates_reference_frame_to_vehicle_data() {
        ...
        assertEquals(0f, vd.current, 0.001f)       // raw counts, currently 0
        ...
        // v1 wire capabilities → current/power uncalibrated, no battery-temp channel.
        assertEquals(false, vd.currentAvailable)
